        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-4">
              ...
              {/* Email notice */}
              <div className="mt-4 mb-4 p-3 bg-blue-900/20 border border-blue-800/50 rounded-lg text-xs text-blue-300 flex items-start gap-2">
                <svg className="w-4 h-4 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>An order confirmation email will be sent to your registered address upon successful placement.</span>
              </div>
