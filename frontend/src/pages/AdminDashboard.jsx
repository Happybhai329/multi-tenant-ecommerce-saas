      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-6 flex flex-col justify-center items-center">
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 max-w-md w-full shadow-2xl">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-400 text-sm mt-1">Super Admin Account</p>
          </div>
          ...
          <div className="border-t border-gray-800 pt-6 space-y-4">
            ...
            <div>
              ...
              <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-900/50 text-purple-300 border border-purple-800/50 capitalize">
                {user?.role}
              </span>
            </div>
          </div>
